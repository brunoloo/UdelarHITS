...
function renderTags() {
  ...
  container.querySelectorAll('.tag-option').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (typeof window.syncCatCounters === 'function') window.syncCatCounters();
    });
  });
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  catTitle.addEventListener('input', window.syncCatCounters);
  catDesc.addEventListener('input', window.syncCatCounters);
